...
[Learn how to download and install Sia-UI](../../../your-wallet/wallet-setup/sia-ui/how-to-download-and-install-sia-ui.md)

[Learn how to create a new wallet in Sia-UI](../../../your-wallet/wallet-setup/sia-ui/how-to-make-a-new-wallet-in-sia-ui.md)
...
You'll need to update your app, but you should do it after the hardfork activates. Updating before the fork will your signatures won't be valid. Use [Ledger Live](../../../your-wallet/wallet-setup/for-advanced-users/using-the-sia-ledger-nano-s-app.md#install\_the\_sia\_ledger\_nano\_s\_app) in Developer mode to find and update the Siacoin app.
