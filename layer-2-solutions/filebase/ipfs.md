---
description: >-
  A peer-to-peer network for storing and sharing data in a distributed file
  system.
---
...
IPFS allows users to host and receive content in a manner similar to [Skynet](../skynet.md). Built around a decentralized system of nodes which hold a portion of the overall data, IPFS creates a resilient system of file storage and sharing.
